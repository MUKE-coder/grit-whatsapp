...
/**
 * Customisations for the Message resource.
 *
 ...
 *
 * Rows are typed as Message, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<Message> = {};
