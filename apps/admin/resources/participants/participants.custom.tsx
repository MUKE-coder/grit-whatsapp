...
/**
 * Customisations for the Participant resource.
 *
 ...
 *
 * Rows are typed as Participant, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<Participant> = {};
