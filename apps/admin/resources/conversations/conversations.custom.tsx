...
/**
 * Customisations for the Conversation resource.
 *
 ...
 *
 * Rows are typed as Conversation, so row.id and friends autocomplete and a renamed
 ...
 */
const custom: ResourceCustomisation<Conversation> = {};
